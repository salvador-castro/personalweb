...
// Extraer texto plano desde children (puede ser string, array, elementos, etc.)
...
const components = {
  ...
  Table: dynamic(() =>
    import("@/once-ui/components").then((mod) => mod.Table)
  ),
  Feedback: dynamic(() =>
  ...
  Card: dynamic(() =>
    import("@/once-ui/components").then((mod) => mod.Card)
  ),
  Grid: dynamic(() =>
    import("@/once-ui/components").then((mod) => mod.Grid)
  ),
  Row: dynamic(() =>
    import("@/once-ui/components").then((mod) => mod.Row)
  ),
  Column: dynamic(() =>
    import("@/once-ui/components").then((mod) => mod.Column)
  ),
  Icon: dynamic(() =>
    import("@/once-ui/components").then((mod) => mod.Icon)
  ),
  SmartImage: dynamic(() =>
