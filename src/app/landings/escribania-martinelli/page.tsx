...
export default function EscribaniaMartinelliLanding() {
  ...
  return (
    <>
      ...
      <section id="inicio" style={{
        minHeight: "100vh",
        background: "linear-gradient(135deg, rgba(30, 64, 175, 0.9) 0%, rgba(55, 48, 163, 0.85) 50%, rgba(30, 58, 138, 0.9) 100%), url('/images/landings/martinelli/hero.png')",
        ...
        <div style={{ maxWidth: "900px", position: "relative", zIndex: 1 }} className="animate-fade-in">
          ...
          <p style={{ 
            ...
            Servicios notariales de excelencia. Más de 30 años de experiencia al servicio de nuestros clientes.
          </p>
          
          <div style={{ display: "flex", gap: "1.2rem", justifyContent: "center", flexWrap: "wrap" }}>
            <a 
              href="https://wa.me/5491134339754?text=Hola! Necesito asesoramiento notarial"
              style={{
                backgroundColor: "#10b981",
                color: "white",
      ...
      <section id="servicios" style={{
        ...
        <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
          ...
          <div style={{
            ...
            {[
              { icon: "🏠", title: "Compraventa de Inmuebles", desc: "Escrituración de propiedades con total garantía legal", color: "#3b82f6", image: "/images/landings/martinelli/compraventa.png" },
              { icon: "🏢", title: "Constitución de Sociedades", desc: "Armá tu empresa con respaldo profesional", color: "#8b5cf6", image: "/images/landings/martinelli/sociedades.png" },
              { icon: "📜", title: "Testamentos y Sucesiones", desc: "Planificá el futuro de tu patrimonio", color: "#ec4899", image: "/images/landings/martinelli/testamentos.png" },
              { icon: "✍️", title: "Certificación de Firmas", desc: "Validación legal de documentos", color: "#10b981", image: "/images/landings/martinelli/certificacion.png" },
              { icon: "📋", title: "Poderes", desc: "Generales y especiales según tus necesidades", color: "#f59e0b", image: "/images/landings/martinelli/poderes.png" },
              { icon: "💼", title: "Asesoramiento Legal", desc: "Consultas sobre trámites notariales", color: "#06b6d4", image: "/images/landings/martinelli/asesoramiento.png" },
            ].map((service, idx) => (
      ...
      <section id="resenas" style={{
        ...
        <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
          ...
          <div style={{
            ...
            {[
              { author: "María Laura Godoy", rating: 5, text: "Excelente atención y profesionalismo. Muy recomendable para cualquier trámite notarial." },
              { author: "Gabriela Fernández", rating: 5, text: "Muy buena atención, te explican todo con claridad. Recomendable 100%." },
              { author: "Cliente Satisfecho", rating: 5, text: "Servicio rápido y eficiente. Profesionales de primer nivel." },
            ].map((review, idx) => (
              <div key={idx} className="hover-lift" style={{
                backgroundColor: "#f8fafc",
                padding: "2.5rem",
          ...
          <div style={{ textAlign: "center", marginTop: "3rem" }}>
            <a 
              href="https://maps.app.goo.gl/huD7nfUHoAFEQhjB7"
              target="_blank"
        ...
        <div style={{ maxWidth: "1100px", margin: "0 auto", position: "relative", zIndex: 1 }}>
          ...
          <div style={{
            ...
            <div style={{ 
              ...
              <p style={{ marginBottom: "0.5rem" }}>Liliana Martinelli</p>
              <p style={{ marginBottom: "1rem" }}>Escribanía</p>
              <a 
                href="https://maps.app.goo.gl/huD7nfUHoAFEQhjB7"
                target="_blank"
                rel="noopener noreferrer"
            ...
            <div style={{ 
              ...
              <p style={{ fontSize: "1.2rem", marginBottom: "1rem" }}>+54 9 11 3433-9754</p>
              <a 
                href="tel:+5491134339754" 
                style={{ 
                  color: "#10b981", 
                  textDecoration: "none", 
                  fontWeight: "600",
      ...
      <footer style={{
        ...
        <p style={{ fontSize: "1rem", opacity: "0.8" }}>
          © 2026 Escribanía Liliana Martinelli - Tu tranquilidad es nuestro compromiso
        </p>
      </footer>
